...
Usage
-----
Add a `ZipkinBundle` to your [Application](http://www.dropwizard.io/1.2.0/dropwizard-core/apidocs/io/dropwizard/Application.html) class.
...
Example Application
-------------------
This bundle includes a modified version of the `HelloWorldApplication` from Dropwizard's [Getting Started](http://www.dropwizard.io/1.2.0/docs/getting-started.html) documentation.
...
```
mvn clean package
java -jar zipkin-example/target/zipkin-example-1.2.0-2-SNAPSHOT.jar server zipkin-example/hello-world.yml
```
