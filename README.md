...
Usage
-----
Add a `ZipkinBundle` to your [Application](http://www.dropwizard.io/1.0.6/dropwizard-core/apidocs/io/dropwizard/Application.html) class.
...
```
mvn clean package
java -jar zipkin-example/target/zipkin-example-1.0.6-2-SNAPSHOT.jar server zipkin-example/hello-world.yml
```
